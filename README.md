...
├── predicted_output.py      # FastAPI application and model logic
├── index.html               # Web interface frontend
├── requirements.txt         # Python dependencies
├── train_ljp_transformer.py # Model training script
...
- 📈 **Confidence Visualization**: Progress bars and probability distributions
- 🔍 **Detailed Reasoning**: Key factors and supporting evidence
- 📝 **Case Summarization**: Automatic text summarization
